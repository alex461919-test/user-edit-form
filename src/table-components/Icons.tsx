...
const PersonIcon = React.forwardRef<SVGSVGElement, IconProps>(({ color, size = '1rem', ...rest }, ref) => {
  return (
    <svg ref={ref} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width={size} height={size} fill={color} {...rest}>
...
const PersonPlusIcon = React.forwardRef<SVGSVGElement, IconProps>(({ color, size = '1rem', ...rest }, ref) => {
  return (
    <svg ref={ref} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width={size} height={size} fill={color} {...rest}>
...
export { ArrowDownUpIcon, SortDownIcon, SortUpIcon, SearchIcon, PersonIcon, PersonPlusIcon };
