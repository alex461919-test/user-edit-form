...
const ArrowDownUp = React.forwardRef<SVGSVGElement, IconProps>(({ color, size, ...rest }, ref) => {
  return (
...
const SortDown = React.forwardRef<SVGSVGElement, IconProps>(({ color, size, ...rest }, ref) => {
  return (
    <svg ref={ref} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width={size} height={size} fill={color} {...rest}>
...
const SortUp = React.forwardRef<SVGSVGElement, IconProps>(({ color, size, ...rest }, ref) => {
  return (
    <svg ref={ref} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width={size} height={size} fill={color} {...rest}>
